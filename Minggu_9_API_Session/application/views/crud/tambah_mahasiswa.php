<div class="row">
  <div class="col-lg-7">
    <div class="p-5">
      ...
      <!-- form ini akan mengerjakan function input dalam controller mahasiswa dengan  -->
      <form class="user" action="<?php echo base_url('Mahasiswa/input'); ?>" method="post">
        ...
        <div class="form-group">
          <input type="text" class="form-control form-control-user" id="nama" name="nama" placeholder="Name Maximal 25 Character" require>
        </div>
        <div class="form-group">
